...
import { User, FileText, LogOut, Shield, Lock, Bus } from 'lucide-react';
import { useState } from 'react';

export function BusDriverSettings() {
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              ...
              <div className="text-[14px] text-[#64748B] mb-1">
                {userInfo.role} • {userInfo.employeeId}
              </div>
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[#EFF6FF] text-[#2563EB] text-[12px] font-medium">
          ...
          <div className="pt-4 border-t border-gray-100 space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-[13px] font-medium text-gray-900">{userInfo.phone}</span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="space-y-2">
            ...
            <button className="w-full bg-white rounded-xl border border-gray-200 p-4 flex items-center gap-3 active:bg-gray-50">
              ...
              <div className="flex-1 text-left">
                ...
                <div className="text-[12px] text-[#64748B]">
                  Completed April 15, 2026 • Valid until April 2027
                </div>
              </div>
            </button>
