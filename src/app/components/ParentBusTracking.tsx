...
export function ParentBusTracking() {
  ...
  const statusConfig = {
    'en-route-school': { label: 'En route to school', color: 'bg-blue-100 text-blue-700' },
    'arrived-school': { label: 'Arrived at school', color: 'bg-green-100 text-green-700' },
    'en-route-home': { label: 'En route home', color: 'bg-cyan-100 text-cyan-700' },
    'approaching-stop': { label: 'Approaching your stop', color: 'bg-amber-100 text-amber-700' },
    'arrived-home': { label: 'Arrived home', color: 'bg-green-100 text-green-700' }
  };

  const currentStatus = statusConfig[busStatus];

  return (
    <div className="min-h-screen bg-gray-50 flex flex-col" style={{ width: '393px', height: '852px' }}>
      {/* Top App Bar */}
      <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1">
          <h1 className="text-lg font-medium text-gray-900">Bus Tracking</h1>
          <p className="text-sm text-gray-600">Route 12</p>
        </div>
      </header>

      <div className="flex-1 overflow-y-auto">
        {/* Map View */}
        <div className="relative bg-slate-100 overflow-hidden" style={{ height: '468px' }}>
          ...
          <div className="absolute inset-0 bg-slate-100">
            ...
            <div className="absolute" style={{ left: '60px', top: '100px' }}>
              <div className="flex flex-col items-center">
                ...
                <div className="mt-1 bg-white px-2 py-1 rounded text-xs font-medium text-gray-900 shadow-sm">
                  Home
                </div>
              </div>
            </div>

            {/* Bus Pin (with direction arrow) */}
            <div className="absolute" style={{ left: '160px', top: '200px' }}>
              <div className="flex flex-col items-center">
                <div className="relative">
                  {/* Animated pulse ring */}
                  <div className="absolute inset-0 bg-green-500 rounded-full animate-ping opacity-30" />
                  <div className="relative bg-green-500 p-2.5 rounded-full shadow-lg">
        ...
        <div className="px-4 pt-4">
          <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
            ...
            <div className="flex items-center gap-1.5 mb-4">
              ...
              <span className="text-xs text-slate-600">Updated 1 min ago</span>
            </div>
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex flex-col items-center flex-1">
                  <div className="relative">
                    <div className="absolute inset-0 bg-amber-500 rounded-full animate-ping opacity-40" style={{ width: '32px', height: '32px' }} />
                    <div className="relative w-8 h-8 rounded-full bg-amber-500 flex items-center justify-center mb-1">
                      <MapPin className="w-4 h-4 text-white" />
                    </div>
                  </div>
                  <span className="text-xs text-slate-700 font-medium">Stop 3</span>
                </div>
                ...
                <div className="flex flex-col items-center flex-1">
                  ...
                  <span className="text-xs text-slate-500">Stop 5</span>
                </div>
