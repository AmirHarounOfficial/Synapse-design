...
import { ArrowLeft, Check, Send, Home } from 'lucide-react';
import { useState } from 'react';

export function BusStudentDeboarding() {
      ...
      <div className="px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#F0FDF4] text-[#065F46] text-[13px] font-medium">
        ...
        <div className="bg-[#FEF3C7] border border-[#F59E0B] rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="text-[13px] text-[#92400E] font-semibold mb-1">
                Safe Drop-off Confirmation
              </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-[12px] text-[#1E40AF] leading-relaxed">
                <strong>{student.parentName}</strong> will receive: "{student.name.split(' ')[0]} has arrived home safely at {currentTime}"
              </p>
            </div>
          </div>
        </div>
            ...
            {!isConfirming ? (
              <>
                ...
                <p className="text-[14px] text-[#64748B] mb-6 text-center">
                  Confirm <strong>{student.name}</strong> has safely arrived home at {currentTime}?
                </p>
